...
\begin{figure*}[!t]
	\begin{center}	
		\includegraphics[bb=0 0 971 266,width=\textwidth]{model_accuracy.pdf}
		\caption{1-norm of relative error from RTF predicted response time compared to actual response time, averaged over 3 trials.}
...
Figure~\ref{model_accuracy} shows the 1-norm of the relative error of the predicted response times.
