...
\begin{figure*}[!t]
	\begin{center}	
		\includegraphics[width=\textwidth]{dyn-alloc-wp.pdf}
		\caption{\fix{combine into one plot} Resource Allocations of video conferencing through time as participants enter and leave and the video in focus changes with the computer operating in wall power mode}
