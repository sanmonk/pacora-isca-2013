...
\begin{figure*}[!t]
	\begin{center}	
		...
		\caption{Wall Power Mode: Resource Allocations of video conferencing through time as the videos change resolution to adjust for who is speaking. Hog represents as background task uploading files.}
...
\begin{figure}[!t]
	\begin{center}	
		...
		\caption{Battery Power Mode: Resource Allocations of video conferencing through time as the videos change resolution to adjust for who is speaking. Hog represents as background task uploading files.}
