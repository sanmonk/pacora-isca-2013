...
possible to provide guaranteed optimization times of around 20
$\micro$s, but at the cost of many more intermediate reallocations.
These results can be found in Appendix~\ref{appendix-dynamic}.
%~\cite{pacora_tr}.
We choose this
...
for the video scenario. The algorithm runs in 50 $\micro$s on average,
with more significant reallocations taking from 250-350 $\micro$s.
