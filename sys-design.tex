...
PACORA formulates resource allocation as an optimization problem built from two types of application-specific functions.  \fix{why?} The following sections describe each of the functions and the optimization construction.
