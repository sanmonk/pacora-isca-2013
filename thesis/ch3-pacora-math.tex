...
\caption{\label{stencil_outlier_fig}Response time function with some resource ``plateaus''.}
\end{figure}

\begin{figure}[hb]
\center
\includegraphics*[width=.80\columnwidth]{Figures/mem_page_data.png}
\caption{\label{mem_page_fig}Response time function with some resource ``plateaus''.}
\end{figure}
