...
Ideally, performance targets would be inferred by the system or provided by a
...
%\footnote{For cloud systems, applications typically provide
%  their resource requirements to the system, which necessitates
%  applications understanding their own performance and requires the
%  system to trust the application.}.
