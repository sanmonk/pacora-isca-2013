...
In our study we experience resource variability both in the form of non-determistic resources such as the network connection in {\tt tradebeans} and shared resources such as memory bandwidth.
