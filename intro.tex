...
additional storage per application.  We have found that the impact of model accuracy on the quality of resource allocations is not significant; models with errors above 30\% still produce in near optimal allocations.  This effect enables modeling to be feasible in a real system with variable applications.
